...
background = pygame.image.load('D:/Python/project/feed_the_dragon/dragon_night.jpg')
background_rect = background.get_rect()
background_rect.topleft = (0,0)

#setup the actors
coin = pygame.image.load('D:/Python/project/feed_the_dragon/coin.png')
coin_rect = coin.get_rect()
coin_rect.left = BUFFER_DISTANCE
coin_rect.top = random.randint(64, WINDOW_HEIGHT-64)


dragon = pygame.image.load('D:/Python/project/feed_the_dragon/dragon.png')
dragon_rect = dragon.get_rect()
dragon_rect.centery = WINDOW_HEIGHT//2
dragon_rect.right = WINDOW_WIDTH -10

#setup the sound and music
pickup = pygame.mixer.Sound('D:/Python/project/feed_the_dragon/pickup.wav')
loss = pygame.mixer.Sound('D:/Python/project/feed_the_dragon/loss.wav')

pygame.mixer.music.load('D:/Python/project/feed_the_dragon/background_music.mp3')
...
#font
game_font = pygame.font.Font('D:/Python/project/feed_the_dragon/AttackGraffiti.ttf', 32) #fontname, fontsize
...
while running:
    ...
    for ev in pygame.event.get():
        if ev.type == pygame.QUIT:
            ...
            elif ev.key == pygame.K_UP and dragon_rect.top > 64 and game_status==1: #down arrow key pressed and game is running
                dragon_rect.top -= DRAGON_VELOCITY
